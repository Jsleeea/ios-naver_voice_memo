...
class TodoListViewModel: ObservableObject {
    ...
    @Published var isEditModeTodoMode: Bool
    ...
    var navigationBarRightBtnMode: NavigationBtnType {
        isEditModeTodoMode ? .complete : .edit
    }
    ...
    init(todos: [Todo] = [],
        ...
        self.todos = todos
        self.isEditModeTodoMode = isEditModeTodoMode
...
extension TodoListViewModel {
    ...
    func navigationRightBtnTapped() {
        if isEditModeTodoMode {
            if removeTodos.isEmpty {
                isEditModeTodoMode = false
            } else{
                setIsDisplayRemoveTodoAlert(true)
            }
        } else {
                isEditModeTodoMode = true
        }
    }
